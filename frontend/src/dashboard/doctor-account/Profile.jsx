      ...
      <form>
        ...
        <div className="mb-5">
            ...
            <div key={index}>
              <div>
                ...
                <button
                  ...
                  className="bg-red-600 p-2 rounded-full text-while text-[18px] mt-2 mb-[30px] cursor-pointer"
                >
                  <AiOutlineDelete />
                </button>
              </div>
          ...
          <button
            ...
            className="bg-[#000] py-2 px-5 rounded text-white text-[18px] mt-2 mb-[30px] cursor-pointer"
          >
            Add Qualification
          </button>
        </div>
                ...
                <div className="grid grid-cols-2 gap-5 md:grid-cols-4 mb-[30px]">
                  ...
                  <div className="flex items-center">
                    <button
                      ...
                      className="bg-red-600 p-2 rounded-full text-while text-[18px] mt-6 cursor-pointer"
                    >
                      <AiOutlineDelete />
                    </button>
                  </div>
